<?php
    ...
    //$respuesta = mysql_query($query, $link);
...
//        $primer_apellido = $nombre[0];
  //      $primer_nombre = $nombre[2];
    ...
    if ($str_dependencia_economica_conyuge==true){
      $pdf->text(136.8, 190.2,'X');
    }else if ($str_dependencia_economica_conyuge==false){
    ...
    $pdf->SetFont('Arial', '', 8);
    //$pdf->text(18, 193, $str_nombre_tomador2);
    ...
    $pdf->text(150, 45, $int_ano_diligenciamiento);


    $pdf->text(22, 111, $str_nombre_tomador2);
    ...
    //$pdf->text(16, 63, $str_nombre_tomador2);
...
//        case 'CC': $pdf->text(98, 149.2, 'X'); break;
  //      case 'CE': $pdf->text(108, 149.2, 'X'); break;
    ...
    //$pdf->text(24, 75.9, $str_nombre_tomador2);
