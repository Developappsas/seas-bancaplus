<?php
    ...
    switch ($tipo_documento)
    {
        case "TODO":
            break;
        case "CONOCIMIENTO_CLIENTE":
            formatoConocimientoCliente();
            break;    
        case "PAGARE":
            formatoPagare();
            break;    
        case "LIBRANZA":
            formatoLibranza();
            break;    
        case "COSTO_ADMINISTRACION":
            formatoAutorizacionCostoAdministracion();
            break;    
        case "PLANTILLA_AUTORIZACION":
            formatoAutorizacionDescuento();
            break;    
        case "AUTORIZACION_DESCUENTO":
            formatoAutorizacionDescuentoPesionados();
            break;   
        case "INDIVIDUAL_SEGUROS":
            formatoColmenaIndividual();
            break; 
        case "NOVEDADES_BENEFICIARIOS":
            formatoColmenaBeneficiarios();
            break; 
        case "AUTORIZACION_DESCUENTO_COLFONDOS":
            formatoDescuentoColfondos();
            break; 
    }
    ...
    function formatoConocimientoCliente()
    {
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0002.jpg', 5, 5, 202);
        $pdf->text(160, 40, $int_numero_libranza);
        //Dia
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0003.jpg', 5, 5, 202);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0004.jpg', 5, 5, 202);
        ...
        if ($str_residente_usa_green_card? $pdf->text(172.5, 68.5, 'X') : $pdf->text(185, 68.5, 'X'));
        if ($str_obligado_tributario_exterior? $pdf->text(172.5, 76.5, 'X') : $pdf->text(185, 76.5, 'X'));
        if ($str_otorgo_poder_persona_viva_exterior? $pdf->text(172.7, 85, 'X') : $pdf->text(185.2, 85  , 'X'));
         
        $pdf->text(17, 108, $str_apoderado_1_exterior_pais);
        $pdf->text(65, 108, $str_apoderado_1_exterior_identificacion);
        $pdf->text(137, 108, $str_apoderado_1_exterior_objeto);
    
        $pdf->text(17, 117, $str_apoderado_2_exterior_pais);
        $pdf->text(65, 117, $str_apoderado_2_exterior_identificacion);
        $pdf->text(137, 117, $str_apoderado_2_exterior_objeto);
        ...
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(22, 190, $str_nombre_tomador2);
        $pdf->text(135, 190, $int_identificacion_solicitante);
        $pdf->SetFont('Arial', '', 10);  
    
    
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0005.jpg', 5, 5, 202);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(35, 30, $str_actividades);
        
        $pdf->text(42, 43.3, $str_nombre_tomador2);
        $pdf->text(38, 46.2, $int_identificacion_solicitante);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(100, 46.2, $str_lugar_expedicion_solicitante);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(35, 48.9, $str_nombre_tomador2);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0006.jpg', 5, 5, 202);
        ...
        $pdf->text(24, 141, "$".$int_cuota_mensual);
        $pdf->text(72, 141, $int_cantidad_cuotas_descuento); 
        $pdf->text(120, 141, "$".$int_valor_inicial); 
        $pdf->text(168, 141, $int_tasa_interes_2decimal);   
        ...
        $pdf->text(155, 203, $int_numero_libranza);
        ...
        $pdf->Image('../images/logo_pagare.png', 15, 183, 28);
        $pdf->SetFont('Arial', '', 8);
        $pdf->text(45, 185, 'Firmado electronicamente por:');
        $pdf->SetFont('Arial', '', 6);
        $pdf->text(45, 188, $str_nombre_tomador);
        $pdf->SetFont('Arial', '', 8);
        $pdf->text(45, 191, 'CC'.$int_identificacion_solicitante);
        $pdf->text(45, 194, 'Fecha: '.$str_fecha_diligenciamiento);
    ...
    function formatoLibranza()
    {
        ...
        $pdf->text(103, 113, "$".$int_cuota_mensual." - ".$int_cantidad_cuotas_descuento . " cuotas");
    ...
    function formatoAutorizacionCostoAdministracion()
    {
      include ('variables.php');
      $pdf = new FPDF();
      $pdf->SetFont('Arial', '', 10);
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0011.jpg', 5, 5, 202);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(30, 46, $str_ciudad_diligenciamiento);
        $pdf->text(95, 46, $int_dia_diligenciamiento);
        $pdf->text(132, 46, $int_mes_diligenciamiento);
        $pdf->text(170, 46, $int_ano_diligenciamiento);
    
    
        $pdf->text(22, 111.5, $str_nombre_tomador2);
        $pdf->text(105, 115, $int_identificacion_solicitante);
        $pdf->SetFont('Arial', '', 7);
        ...
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(137, 159, $str_ciudad_diligenciamiento);
        $pdf->SetFont('Arial', '', 10);
        $pdf->text(22, 162, $int_dia_diligenciamiento);
        $pdf->text(80, 162, $str_mes_letras_diligencamiento);
        $pdf->text(130, 162, $int_ano_diligenciamiento);
    
    
    
        $pdf->text(18, 195, $str_primer_nombre_solicitante." ".$str_segundo_nombre_solicitante." ".$str_primer_apellido_solicitante." ".$str_segundo_apellido_solicitante);
        $pdf->text(30, 203, $int_identificacion_solicitante);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(80, 203, $str_lugar_expedicion_solicitante);
        $pdf->SetFont('Arial', '', 10);
        $pdf->text(37, 215, $str_direccion_domicilio_solicitante);
        $pdf->text(35, 226, $str_celular_solicitante);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(34, 240, $str_ciudad_domicilio_solicitante."/".$str_departamento_domicilio_solicitante);
        $pdf->SetFont('Arial', '', 10);
    
        $pdf->Image('../images/logo_pagare.png', 29, 167, 28);
        $pdf->SetFont('Arial', '', 8);
        $pdf->text(62, 169, 'Firmado electronicamente por:');
        $pdf->text(62, 172, $str_nombre_tomador);
        $pdf->text(62, 175, 'CC'.$int_identificacion_solicitante);
        $pdf->text(62, 178, 'Fecha: '.$str_fecha_diligenciamiento);
    ...
    function formatoAutorizacionDescuento()
    {
      include ('variables.php');
      $pdf = new FPDF();
      $pdf->SetFont('Arial', '', 10);
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
      $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0012.jpg', 5, 5, 202);
        ...
        $pdf->AddPage();
        //PLANTILLA 2
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0013.jpg', 5, 5, 202);
    ...
    function formatoAutorizacionDescuentoPesionados()
    {
      include ('variables.php');
      $pdf = new FPDF();
      $pdf->SetFont('Arial', '', 10);
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
        $pdf->AddPage();
        //PLANTILLA 2
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0014.jpg', 5, 5, 202);
        ...
        $pdf->Image('../images/logo_pagare.png', 17, 165, 16);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(36, 165, 'Firmado electronicamente por:');
        $pdf->text(36, 168, $str_nombre_tomador);
        $pdf->text(36, 171, 'CC'.$int_identificacion_solicitante);
        $pdf->text(36, 174, 'Fecha: '.$str_fecha_diligenciamiento);
    ...
    function formatoColmenaIndividual()
    {
      include ('variables.php');
      $pdf = new FPDF();
      $pdf->SetFont('Arial', '', 10);
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
      $pdf->AddPage();
      $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0015.jpg', 5, 5, 202);
        ...
        $pdf->text(88, 83, $str_dia_expedicion_solicitante);
        $pdf->text(94, 83, $str_mes_expedicion_solicitante);
        $pdf->text(98.5, 83, $str_ano_expedicion_solicitante);
        ...
        $pdf->text(144, 90, $str_email_solicitante);
        $pdf->SetFont('Arial', '', 8);
        $pdf->text(15, 97, $str_ocupacion_solicitante);
        $pdf->text(88, 97, $str_celular_solicitante);

        $pdf->text(152, 97, $str_estatura);
        $pdf->text(182, 97, $str_peso);
        ...
        $pdf->text(50, 138.5, $int_plazo_meses);
        ...
        if ($int_condicion1_declaracion_asegurabilidad=='SI'){
            $pdf->text(182, 189, "X");
        }else if ($int_condicion1_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 189, "X");    
        }
        
        if ($int_condicion2_declaracion_asegurabilidad=='SI'){
           $pdf->text(182, 192, "X");
        }else if ($int_condicion2_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 192, "X");    
        }
        
        if ($int_condicion3_declaracion_asegurabilidad=='SI'){
           $pdf->text(182, 195, "X");
        }else if ($int_condicion3_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 195, "X");    
        }
    
        if ($int_condicion4_declaracion_asegurabilidad=='SI'){
           $pdf->text(182, 198.8, "X");
        }else if ($int_condicion4_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 198.8, "X");    
        }
        
        if ($int_condicion5_declaracion_asegurabilidad=='SI'){
            $pdf->text(182, 202, "X");
        }else if ($int_condicion5_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 202, "X");    
        }
        
        if ($int_condicion6_declaracion_asegurabilidad=='SI'){
            $pdf->text(182, 207, "X");
        }else if ($int_condicion6_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 207, "X");     
        }         
    
        if ($int_condicion7_declaracion_asegurabilidad=='SI'){
           $pdf->text(182, 215, "X");
        }else if ($int_condicion7_declaracion_asegurabilidad=='NO'){
           $pdf->text(191, 215, "X");    
        }
        
        if ($int_condicion8_declaracion_asegurabilidad=='SI'){
            $pdf->text(182, 219, "X");    
        }else if ($int_condicion8_declaracion_asegurabilidad=='NO'){
            $pdf->text(191, 219, "X");    
        }
        
        $pdf->SetFont('Arial', '', 6);
        $pdf->text(51, 225.1, $str_nombre_enfermedad_declaracion_asegurabilidad);        
        $pdf->text(149, 228.5, $str_tratamientos_medicos_declaracion_asegurabilidad);
        $pdf->text(35, 228.5, $str_fecha_diagnostico_declaracion_asegurabilidad);    
        $pdf->text(37, 231.5, $str_secuelas_declaracion_asegurabilidad);
        $pdf->text(156.4, 231.8, $str_tratamiento_actual_declaracion_asegurabilidad);
        $pdf->text(50, 235.3, $str_observaciones_declaracion_asegurabilidad);
    
        $pdf->AddPage();
        
        //ASEGURABILIDAD 2
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0016.jpg', 5, 5, 202);
        ...
        //{
          //  $pdf->text(163, 187, "X");
        //}
        $pdf->Image('../images/logo_pagare.png', 110, 235, 16);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(128, 233, 'Firmado electronicamente por:');
        $pdf->text(128, 236, $str_nombre_tomador);
        $pdf->text(128, 239, 'CC'.$int_identificacion_solicitante);
        $pdf->text(128, 242, 'Fecha: '.$str_fecha_diligenciamiento);
    ...
    function formatoColmenaBeneficiarios()
    {
      include ('variables.php');
      $pdf = new FPDF();
      $pdf->SetFont('Arial', '', 10);
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0017.jpg', 5, 5, 202);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/KREDIT 04-22/KREDIT_page-0018.jpg', 5, 5, 202);
        ...
        $pdf->Image('../images/logo_pagare.png', 20, 235, 16);
        $pdf->SetFont('Arial', '', 7);
        $pdf->text(38, 234, 'Firmado electronicamente por:');
        $pdf->text(38, 237, $str_nombre_tomador);
        $pdf->text(38, 240, 'CC'.$int_identificacion_solicitante);
        $pdf->text(38, 243, 'Fecha: '.$str_fecha_diligenciamiento);
    ...
    function formatoDescuentoColfondos()
    {
      include ('variables.php');
      $pdf = new FPDF();
      $pdf->SetFont('Arial', '', 10);
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
            ...
            $pdf->text(40, 124, $str_nombre_tomador2);
            $pdf->text(118, 130, $int_identificacion_solicitante);


            $pdf->Image('../images/logo_pagare.png', 35, 195, 16);
            $pdf->SetFont('Arial', '', 7);
            $pdf->text(55, 196, 'Firmado electronicamente por:');
            $pdf->text(55, 199, $str_nombre_tomador);
            $pdf->text(55, 202, 'CC'.$int_identificacion_solicitante);
            $pdf->text(55, 205, 'Fecha: '.$str_fecha_diligenciamiento);
            $pdf->text(33, 210, $str_nombre_tomador2);
