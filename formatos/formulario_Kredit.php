<?php
    ...
    $pdf->text(42, 43.5, $str_nombre_tomador2);
    $pdf->text(38, 46.5, $int_identificacion_solicitante);
    $pdf->SetFont('Arial', '', 7);
    $pdf->text(100, 46.5, $str_lugar_expedicion_solicitante);
    $pdf->SetFont('Arial', '', 10);
    $pdf->text(35, 49.5, $str_nombre_tomador2);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/KREDIT 04-22/FORMULARIO_OF.jpg', 5, 5, 202);
    $pdf->SetFont('Arial', '', 7);
    $pdf->text(40, 46, $str_ciudad_diligenciamiento);
    $pdf->text(100, 46, $int_dia_diligenciamiento);
    $pdf->text(132, 46, $int_mes_diligenciamiento);
    $pdf->text(170, 46, $int_ano_diligenciamiento);


    $pdf->text(30, 130, $str_nombre_tomador2);
    $pdf->text(80, 134, $int_identificacion_solicitante);
    $pdf->SetFont('Arial', '', 7);
    $pdf->text(150, 134, $str_lugar_expedicion_solicitante);
    $pdf->SetFont('Arial', '', 10);
    $pdf->text(45, 138, $str_ciudad_domicilio_solicitante);
    //$pdf->text(34, 132.5, $int_numero_cuenta_giro);
    //$pdf->text(31, 136, $str_entidad_cuenta_giro);
    //$pdf->text(88, 136, $str_tipo_cuenta_giro);
    $pdf->SetFont('Arial', '', 7);
    $pdf->text(104, 177, $str_ciudad_diligenciamiento);
    $pdf->SetFont('Arial', '', 10);
    $pdf->text(170, 177, $int_dia_diligenciamiento);
    $pdf->text(74, 182, $str_mes_letras_diligencamiento);
    $pdf->text(116, 182, $int_ano_diligenciamiento);



    $pdf->text(20, 212, $str_primer_nombre_solicitante." ".$str_segundo_nombre_solicitante." ".$str_primer_apellido_solicitante." ".$str_segundo_apellido_solicitante);
    $pdf->text(40, 224, $int_identificacion_solicitante);
    $pdf->SetFont('Arial', '', 7);
    $pdf->text(45, 232, $str_lugar_expedicion_solicitante);
    $pdf->SetFont('Arial', '', 10);
    $pdf->text(37, 240, $str_direccion_domicilio_solicitante);
    $pdf->text(35, 248, $str_celular_solicitante);
    $pdf->SetFont('Arial', '', 7);
    $pdf->text(34, 256, $str_ciudad_domicilio_solicitante."/".$str_departamento_domicilio_solicitante);
    $pdf->SetFont('Arial', '', 10);
    $pdf->AddPage();
    $pdf->AddPage();
    //PLANTILLA 1
