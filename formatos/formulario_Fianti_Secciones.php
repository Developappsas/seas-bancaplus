<?php
    ...
    function formatoConocimientoCliente()
    {
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0001.jpg', 5, 5, 202);
        $pdf->text(160, 40, $int_numero_libranza);
        //Dia
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0002.jpg', 5, 5, 202);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0003.jpg', 5, 5, 202);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0004.jpg', 5, 5, 202);        
        $pdf->SetFont('Arial', '', 7);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0005.jpg', 5, 5, 202);
    ...
    function formatoAutorizacionCostoAdministracion()
    {
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
        ...
        $pdf->Image('../images/logo_pagare.png', 20, 186, 27);
        $pdf->SetFont('Arial', '', 8);
        $pdf->text(48, 188, 'Firmado electronicamente por:');
        $pdf->text(48, 191, 'CC'.$int_identificacion_solicitante);
        $pdf->text(48, 194, $str_nombre_tomador);
        $pdf->text(48, 197, 'Fecha: '.$str_fecha_diligenciamiento);
    ...
    function formatoAutorizacionDescuento()
    {
      ...
      $pdf->AddPage();
        ...
        $pdf->AddPage();
        //PLANTILLA 2
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0012.jpg', 5, 5, 202);
    ...
    function formatoAutorizacionDescuentoPesionados()
    {
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
        $pdf->AddPage();
        //PLANTILLA 2
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0013.jpg', 5, 5, 202);
    ...
    function formatoColmenaIndividual()
    {
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
      $pdf->AddPage();
      $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0014.jpg', 5, 5, 202);
        ...
        //ASEGURABILIDAD 2
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0015.jpg', 5, 5, 202);
    ...
    function formatoColmenaBeneficiarios()
    {
      ...
      $pdf->SetCreator('Sistemas Kredit', true);
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0016.jpg', 5, 5, 202);
        ...
        $pdf->AddPage();
        $pdf->Image('./plantillas/FIANTI 12-22/FIANTI_page-0017.jpg', 5, 5, 202);
