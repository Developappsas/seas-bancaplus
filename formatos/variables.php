<?php
  ...
  b.nro_libranza,b.plazo,b.valor_credito,b.tasa_interes, round(b.tasa_interes, 2) AS tasa_interes_2decimal, k.nombre as oficina,j.nombre as nombre_comercial,
  j.apellido as apellido_comercial,j.cedula as cedula_comercial, l.firma_experian, l.pagare_deceval, b.pagaduria
  FROM solicitud a
  ...
  $int_total_pagar =  intval($int_cantidad_cuotas_descuento)*intval($int_cuota_descuento);
    ...
    //if (count($nombre) == 3) {  $str_primer_nombre_solicitante = $nombre[2]; }
        ...
        $cargo_publico=$fila["cargo_publico"];
        $criptomoneda=$fila["criptomoneda"];
        $actividades_apnfd=$fila["actividades_apnfd"];
