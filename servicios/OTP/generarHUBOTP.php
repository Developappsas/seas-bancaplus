    ...
    if ($celular && $cedula){
        ...
        try {
            ...
            if ($data2->statusCode == 200) {
                ...
                $response = array("code" => "200", "mensaje" => "Se ejecutó correctamente, ".$data2->description, "id" => $id_formulario);
            } else {
                header("HTTP/2.0 200 OK");
                $response = array("code" => "404", "mensaje" => "No Se Obtuvo Respuesta 2 del servidor", "data" => $opciones2, "dat2" => $data2, "dat3" => $rutaOTP."generator");
            }
        } catch (\Throwable $e) {
            header("HTTP/2.0 200 OK");
