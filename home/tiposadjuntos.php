...
<tr>
	<td class="titulo"><center><b>Tipos Adjuntos</b><br><br></center></td>
</tr>
</table>
<form name=formato method=post action="tiposadjuntos_crear.php" onSubmit="return chequeo_forma()">
<table>
<tr>
<td>
...
<form name="formato2" method="post" action="tiposadjuntos.php">
<table>
<tr>
<td>
...
$queryDB = "SELECT * from tipos_adjuntos where id_tipo IS NOT NULL AND id_tipo NOT IN (".$tiposadjuntos_firmados.")";

$queryDB_count = "SELECT COUNT(*) as c from tipos_adjuntos where id_tipo IS NOT NULL AND id_tipo NOT IN (".$tiposadjuntos_firmados.")";
	...
	if ($cuantos > $x_en_x)
	{
		...
		while ($final < $cuantos)
		{
			...
			if ($link_page != $_REQUEST["page"])
				{
				echo " <a href=\"tiposadjuntos.php?descripcion_busqueda=".$descripcion_busqueda."&page=$link_page\">$i</a>";
			}
			else
			{
				echo " ".$i;
		...
		if ($_REQUEST["page"] != $link_page)
		{
			...
			echo " <a href=\"tiposadjuntos.php?descripcion_busqueda=".$descripcion_busqueda."&page=".$siguiente_page."\">Siguiente</a></p></td></tr>";
		}
...
?>
<form name="formato3" method="post" action="tiposadjuntos_actualizar.php">
...
<tr <?php echo $tr_class ?>>
	...
	<td><input type=button value="Modificar" onClick="document.formato3.action.value='actualizar'; document.formato3.id.value='<?php echo $fila["id_tipo"] ?>'; modificar(document.formato3.n<?php echo $fila["id_tipo"] ?>)"></td>
