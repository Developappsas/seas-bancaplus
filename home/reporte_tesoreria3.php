...
$querySession = mysqli_query($link, "SELECT usr FROM proveedores WHERE usr = '".$_POST['user']."' AND passwd = MD5('".$_POST['password']."')");

if(!$querySession || mysqli_num_rows($querySession) == 0){
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS =>'{"id_simulacion":"","origen":"REPORTE TESORERIA","usuario":"'.$_POST["S_IDUSUARIO"].'","operacion":"Crear Simulaciones Consultas Log"}',
