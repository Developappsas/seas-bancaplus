...
function chequeo_forma() {
	...
	with (document.formato) {
		...
		a=window.open('reporte_colocacion2.php?fecha_inicialbm='+fecha_inicialbm.options[fecha_inicialbm.selectedIndex].value+'&fecha_inicialba='+fecha_inicialba.options[fecha_inicialba.selectedIndex].value+'&fecha_finalbm='+fecha_finalbm.options[fecha_finalbm.selectedIndex].value+'&fecha_finalba='+fecha_finalba.options[fecha_finalba.selectedIndex].value,'LCONSFS','toolbars=yes,scrollbars=yes,resizable=yes,width=800,height=600,top=0,left=0');
	}
...
<tr>
	...
	<td class="titulo"><center><b>Reporte Originacion x Comercial</b><br><br></center></td>

</tr>

</table>

<form name=formato method=post action="reporte_colocacion2.php">
<table>
<tr>
<td>
