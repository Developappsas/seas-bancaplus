...
<tr>
	...
	<?php if ($_SESSION["FUNC_BOLSAINCORPORACION"]) { ?><th>Bolsa Incorporacion</th><?php } ?>
	<th>Sector</th>
	<th>Pagaduria</th>
	<th>Plazo</th>
	<th>Incorporacion</th>
...
/*		if ($_REQUEST["calificacion"] == "-1")
	...
	$queryDB .= " group by si.id_simulacion, si.cedula, si.fecha_desembolso, si.fecha_cartera, si.nombre, si.direccion, si.telefono, si.celular, si.email, ase.nombre, ase.apellido, si.nro_libranza, si.tasa_interes, si.opcion_credito, si.opcion_cuota_cso, si.opcion_desembolso_cso, si.valor_credito, si.valor_por_millon_seguro, si.porcentaje_extraprima, si.pagaduria, si.plazo, si.fecha_prepago, si.valor_prepago, si.valor_liquidacion, cu2.seguro, pa.nombre";
}
...
<tr>
	...
	<?php if ($_SESSION["FUNC_BOLSAINCORPORACION"]) { ?><td><?php echo $fila["saldo_bolsa"] ?></td><?php } ?>
...
<tr>
	...
	<?php if ($_SESSION["FUNC_BOLSAINCORPORACION"]) { ?><td><b><?php echo $total_saldo_bolsa ?></b></td><?php } ?>
	<td colspan="7">&nbsp;</td>
