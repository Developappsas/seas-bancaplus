...
if (!$_SESSION["S_LOGIN"] || !$_SESSION["FUNC_FULLSYSTEM"] || ($_SESSION["S_TIPO"] != "ADMINISTRADOR" && $_SESSION["S_TIPO"] != "CARTERA" && $_SESSION["S_TIPO"] != "OPERACIONES" && $_SESSION["S_TIPO"] != "CONTABILIDAD" && $_SESSION["S_SUBTIPO"] != "ANALISTA_CARTERA" && $_SESSION["S_SUBTIPO"] != "COORD_CREDITO" && $_SESSION["S_SUBTIPO"] != "ANALISTA_BD" &&  $_SESSION["S_SUBTIPO"] != "COORD_VISADO"))
{
	exit;
}
...
<tr>
	<td class="titulo"><center><b>Reporte Imputaci&oacute;n Pagos</b><br><br></center></td>
</tr>
</table>
<form name=formato method=post action="cartera_exportarimputacion.php">
<table>
<tr>
<td>
