...
<?php	
	...
	<form name="formato2" method="post" action="simulaciones.php">
				...
				if ($_REQUEST["chk".$fila["id_simulacion"]] == "1")
				{
					if ($_REQUEST["action"] == "anular")
					{
						if ($fila["estado"] == "ING" || $fila["estado"] == "EST")
						{
							...
							$fila2 = sqlsrv_fetch_array($ultima_caracterizacion, SQLSRV_FETCH_ASSOC);
							...
							if ($fila2["cod_transaccion"])
							{
								...
								if (sqlsrv_num_rows($hay_para_reversar))
								{
									...
									$fila4 = sqlsrv_fetch_array($rs4, SQLSRV_FETCH_ASSOC);
		...
		if ($_REQUEST["buscar"])
		{
			...
			$fila_suma = sqlsrv_fetch_array($rs_suma, SQLSRV_FETCH_ASSOC);
				...
				<?php
					...
					if ($queryDocumentacionDigital == false) {
					  ...
					  //Fin Prueba 
						...
						$resDocumentacionDigital=sqlsrv_fetch_array($queryDocumentacionDigital, SQLSRV_FETCH_ASSOC);
						$tr_class = "";
					  ...
					  //Fin Prueba 
							...
							$fila_count1 = sqlsrv_fetch_array($rs_count1, SQLSRV_FETCH_ASSOC);
							...
							if ($cuantos1)
							{
					           ...
					           //Fin Prueba 
								...
								$fila_suma1 = sqlsrv_fetch_array($rs_suma1, SQLSRV_FETCH_ASSOC);
							...
							<tr <?php echo $tr_class ?>>
								...
								if ($fila["resp_gestion_cobranza"]=="")
								{
									...
									//Prueba Query
										...
										//Fin Prueba 
									$resCobranza=sqlsrv_fetch_array($queryCobranza, SQLSRV_FETCH_ASSOC);
