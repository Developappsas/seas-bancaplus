...
<table border="0">
	<tr>
		...
		<th>Tipo de contrato (Sólo aplica para Asalariados)</th>
		<th>Antigüedad en la actividad (meses)</th>
	...
	if (!$_REQUEST["ext"]) {
		...
		where vd.id_venta = '" . $_REQUEST["id_venta"] . "' AND si.nivel_contratacion <> 'PENSIONADO'";
		...
		LEFT JOIN cuotas" . $sufijo . " cu ON si.id_simulacion = cu.id_simulacion AND cu.cuota >= vd.cuota_desde AND cu.cuota <= vd.cuota_hasta 
