...
<tr>
	<td class="titulo"><center><b>Tipos Gesti&oacute;n Cobro</b><br><br></center></td>
</tr>
</table>
<form name=formato method=post action="tiposgestioncobro_crear.php" onSubmit="return chequeo_forma()">
<table>
<tr>
<td>
...
<form name="formato2" method="post" action="tiposgestioncobro.php">
<table>
<tr>
<td>
...
$queryDB = "select * from tipos_gestioncobro where id_tipo IS NOT NULL";

$queryDB_count = "select COUNT(*) as c from tipos_gestioncobro where id_tipo IS NOT NULL";
	...
	if ($cuantos > $x_en_x)
	{
		...
		while ($final < $cuantos)
		{
			...
			if ($link_page != $_REQUEST["page"])
				{
				echo " <a href=\"tiposgestioncobro.php?descripcion_busqueda=".$descripcion_busqueda."&page=$link_page\">$i</a>";
			}
			else
			{
				echo " ".$i;
		...
		if ($_REQUEST["page"] != $link_page)
		{
			...
			echo " <a href=\"tipossgestioncobro.php?descripcion_busqueda=".$descripcion_busqueda."&page=".$siguiente_page."\">Siguiente</a></p></td></tr>";
		}
...
?>
<form name="formato3" method="post" action="tiposgestioncobro_actualizar.php">
