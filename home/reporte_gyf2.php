...
header("Content-Disposition: attachment; filename=PlanoDatos.xls");
...
<tr>
	...
	<th>Situacion Compa&ntilde;ia</th>

	<th>Fecha Sit.Compa&ntilde;ia</th>
...
RIGHT(REPLICATE('0', 5) + '0', 5) as cargo_cliente from 
simulaciones join solicitud on solicitud.id_simulacion = simulaciones.id_simulacion where simulaciones.estado = 'DES'";
