<?php
    ...
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-01.png', 5, 5, 202);
    ...
    if ($istr_mpacto_social_politica ? $pdf->text(62, 210.7, 'X') : $pdf->text(74, 210.7, 'X'));
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-02.png', 5, 5, 202);
    $pdf->text(38, 24.5, $str_ingresos_laborales);
    $pdf->text(130, 24.5, $str_gastos_familiares);
    $pdf->text(43, 33, $str_honorario_comisiones);
    $pdf->text(143, 33, $str_arrendamiento_cuota_vivienda);
    $pdf->text(43, 41, $str_otros_ingresos);
    $pdf->text(132, 41, $str_pasivos);
    $pdf->text(33, 50, $str_total_ingresos);
    $pdf->text(133, 50, $str_pasivos_corrientes);
    $pdf->text(62, 59, $str_activos);
    $pdf->text(134, 59, $str_otros_pasivos);
    $pdf->text(32, 67, $str_total_activos);
    $pdf->text(124, 67, $str_total_pasivos);
    
    $pdf->text(20, 82, $str_referencia_familiar_nombre);
    $pdf->text(109, 82, $str_referencia_familiar_parentezco);
    $pdf->text(158, 82, $str_referencia_familiar_telefono);
    $pdf->text(20, 90, $str_referencia_familiar_direccion);
    $pdf->text(109, 90, $str_referencia_familiar_ciudad);
    $pdf->text(158, 90, $str_referencia_familiar_celular);

    $pdf->text(20, 104, $str_referencia_personal_nombre);
    $pdf->text(109, 104, $str_referencia_personal_parentezco);
    $pdf->text(158, 104, $str_referencia_personal_telefono);
    $pdf->text(20, 112, $str_referencia_personal_direccion);
    $pdf->text(109, 112, $str_referencia_personal_ciudad);
    $pdf->text(158, 112, $str_referencia_personal_celular);

    //Datos Operaciones Internacionales


    if($str_operaciones_moneda_extranjera==true){$pdf->text(22, 130.7, 'X');}else{$pdf->text(34.5, 130.7, 'X');};
    if($str_cuenta_en_el_exterior==true){ $pdf->text(53, 130.7, 'X'); }else{$pdf->text(64.8, 130.7, 'X');};
     
    if($str_operacion_exterior_exportacion==true){$pdf->text(92, 128, 'X');};
    if($str_operacion_exterior_importacion==true){$pdf->text(112, 128, 'X');};
    if($str_operacion_exterior_inversiones==true){$pdf->text(131.5, 128, 'X');};
    if($str_operacion_exterior_prestamo==true){$pdf->text(174.5, 128, 'X') ;};
    if($str_operacion_exterior_otra==true){$pdf->text(92, 133.1, 'X') ;};
    $pdf->text(100, 132.5, $str_operacion_exterior_otra_descripcion);
    
    //Productos en moneda extranjera
    $pdf->text(15, 151, $str_producto_1_moneda_extranjera_nombre);
    $pdf->text(42, 151, $str_producto_1_moneda_extranjera_cuenta);
    $pdf->text(71, 151, $str_producto_1_moneda_extranjera_tipo);
    $pdf->text(106, 151, $str_producto_1_moneda_extranjera_monto);
    $pdf->text(140, 151, $str_producto_1_moneda_extranjera_moneda);
    $pdf->text(160, 151, $str_producto_1_moneda_extranjera_ciudad);
    $pdf->text(180, 151, $str_producto_1_moneda_extranjera_pais); 
    $pdf->text( 15, 159, $str_producto_2_moneda_extranjera_nombre);
    $pdf->text( 42, 159, $str_producto_2_moneda_extranjera_cuenta);
    $pdf->text( 71, 159, $str_producto_2_moneda_extranjera_tipo);
    $pdf->text(106, 159, $str_producto_2_moneda_extranjera_monto);
    $pdf->text(140, 159, $str_producto_2_moneda_extranjera_moneda);
    $pdf->text(160, 159, $str_producto_2_moneda_extranjera_ciudad);
    $pdf->text(180, 159, $str_producto_2_moneda_extranjera_pais);
    $pdf->text( 15, 168, $str_producto_3_moneda_extranjera_nombre);
    $pdf->text( 42, 168, $str_producto_3_moneda_extranjera_cuenta);
    $pdf->text( 71, 168, $str_producto_3_moneda_extranjera_tipo);
    $pdf->text(106, 168, $str_producto_3_moneda_extranjera_monto);
    $pdf->text(140, 168, $str_producto_3_moneda_extranjera_moneda);
    $pdf->text(160, 168, $str_producto_3_moneda_extranjera_ciudad);
    $pdf->text(180, 168, $str_producto_3_moneda_extranjera_pais);
    

    //Declaración FACTCA - CRS
    if ($str_ciudadania_extranjera? $pdf->text(172.5, 184, 'X') : $pdf->text(185, 184, 'X'));
    if ($str_residente_usa_green_card? $pdf->text(172.5, 192.4, 'X') : $pdf->text(185, 192.4, 'X'));
    if ($str_obligado_tributario_exterior? $pdf->text(172.5, 201, 'X') : $pdf->text(185, 201, 'X'));
    if ($str_otorgo_poder_persona_viva_exterior? $pdf->text(172.7, 209.3, 'X') : $pdf->text(185.2, 209.3, 'X'));
     
    $pdf->text(17, 233, $str_apoderado_1_exterior_pais);
    $pdf->text(65, 233, $str_apoderado_1_exterior_identificacion);
    $pdf->text(137, 233, $str_apoderado_1_exterior_objeto);

    $pdf->text(17, 241, $str_apoderado_2_exterior_pais);
    $pdf->text(65, 241, $str_apoderado_2_exterior_identificacion);
    $pdf->text(137, 241, $str_apoderado_2_exterior_objeto);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-03.png', 5, 5, 202);
    ...
    $pdf->SetFont('Arial', '', 8);
    $pdf->text(27, 177.2, $str_actividades);
    $pdf->text(80, 256, $int_clave_consulta_desprendible);
    $pdf->SetFont('Arial', '', 10);
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-04.png', 5, 5, 202);
    ...
    {$pdf->text(160, 155, "X");}
    $pdf->text(165, 155, $str_iniciales_nombre);
    ...
    {$pdf->text(160, 160, "X");}
    $pdf->text(165, 160, $str_iniciales_nombre);

    if ($bool_conoce_adquirir_productos_cancela_libranza==true)
    {$pdf->text(150, 165, "X");}
    else
    {$pdf->text(160, 165, "X");}
    $pdf->text(165, 165, $str_iniciales_nombre);

    if ($bool_conoce_ampliar_plazo_en_caso_mora==true)
    {$pdf->text(150, 170, "X");}
    else
    {$pdf->text(160, 170, "X");}
    $pdf->text(165, 170, $str_iniciales_nombre);

    if ($bool_conoce_valores_descontados==true)
    {$pdf->text(150, 175, "X");}
    else
    {$pdf->text(160, 175, "X");}
    $pdf->text(165, 175, $str_iniciales_nombre);
    ...
    //$pdf->text(18, 199, $str_nombre_tomador);
    $pdf->text(18, 210, $int_identificacion_solicitante);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-05.png', 5, 5, 202);

    //$pdf->text(100, 58, $int_numero_pagare);
    //$pdf->text(103, 78, $int_numero_pagare);
    //$pdf->text(103, 90, $str_nombre_tomador);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-06.png', 5, 5, 202);
   ...
   // $pdf->text(29, 187, $str_ciudad_diligenciamiento);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-09.png', 5, 5, 202);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas/Fianti_Agosto_2021/Fianti_Agosto_2021-10.png', 5, 5, 202);
    $pdf->text(138, 94.5, $int_dia_diligenciamiento);
    $pdf->text(166, 94.5, $str_mes_letras_diligencamiento);
    $pdf->text(22, 97.5, $int_ano_diligenciamiento);
    $pdf->text(60.5, 97.5, $str_ciudad_diligenciamiento);
    ...
    $pdf->AddPage();
    $pdf->Image('./plantillas//Fianti_Agosto_2021/Fianti_Agosto_2021-11.png', 5, 5, 202);
    $pdf->text(30, 45, $str_ciudad_diligenciamiento);
    $pdf->text(95, 45, $int_dia_diligenciamiento);
    $pdf->text(130, 45, $int_mes_diligenciamiento);
    $pdf->text(170, 45, $int_ano_diligenciamiento);


    $pdf->text(22, 119, $str_nombre_tomador);
    $pdf->text(100, 122.5, $int_identificacion_solicitante);
    $pdf->text(17, 125.5, $str_lugar_expedicion_solicitante);
    $pdf->text(124, 125.5, $str_ciudad_domicilio_solicitante);
    //$pdf->text(34, 132.5, $int_numero_cuenta_giro);
    //$pdf->text(31, 136, $str_entidad_cuenta_giro);
    //$pdf->text(88, 136, $str_tipo_cuenta_giro);

    $pdf->text(125, 174.3, $str_ciudad_diligenciamiento);
    $pdf->text(22, 177.3, $int_dia_diligenciamiento);
    $pdf->text(120, 177.3, $str_mes_letras_diligencamiento);
    $pdf->text(16, 180.8, $int_ano_diligenciamiento);



    $pdf->text(17, 208, $str_primer_nombre_solicitante." ".$str_segundo_nombre_solicitante." ".$str_primer_apellido_solicitante." ".$str_segundo_apellido_solicitante);
    ...
    $pdf->text(32, 243, $str_celular_solicitante);
    $pdf->text(29, 251, $str_ciudad_domicilio_solicitante."/".$str_departamento_domicilio_solicitante);
