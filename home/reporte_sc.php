...
function chequeo_forma() {
	with (document.formato) {
		window.open('reporte_sc2.php?cedula='+document.formato.cedula.value+'&id_actividad='+document.formato.id_actividad.options[document.formato.id_actividad.selectedIndex].value+'&fecha_inicialbd='+fecha_inicialbd.options[fecha_inicialbd.selectedIndex].value+'&fecha_inicialbm='+fecha_inicialbm.options[fecha_inicialbm.selectedIndex].value+'&fecha_inicialba='+fecha_inicialba.options[fecha_inicialba.selectedIndex].value+'&fecha_finalbd='+fecha_finalbd.options[fecha_finalbd.selectedIndex].value+'&fecha_finalbm='+fecha_finalbm.options[fecha_finalbm.selectedIndex].value+'&fecha_finalba='+fecha_finalba.options[fecha_finalba.selectedIndex].value,'SCFS','toolbars=yes,scrollbars=yes,resizable=yes,width=800,height=600,top=0,left=0');
	}
}
//-->
</script>
...
<tr>
	<td class="titulo"><center><b>Reporte Servicio al Cliente</b><br><br></center></td>
</tr>
</table>
<form name=formato method=post action="reporte_sc2.php">
<table>
<tr>
<td>
...
<tr>
	<td align="right">Actividad/Solicitud</td><td>
		<select name="id_actividad">
			<option value=""></option>
<?php

$queryDB = "SELECT id_actividad, nombre from actividadessc order by nombre";
