...
if($fila["seguro_parcial"] && $fila["sin_seguro"]){
    ...
    if($fila["seguro_parcial"]){
        ...
        $seguro_total = $seguro_a_causar;
    }        
}

if ($fila["sin_seguro"] == 0){
...
if($fila["sin_seguro"]){
    $seguro_causado = $seguro_a_causar * $cuotas_causadas;
}else{
    $seguro_causado = 0;
}
...
<form name="formato" method="post" action="cartera_actualizar2.php?ext=<?php echo $_REQUEST["ext"] ?>">
   <input type="hidden" name="action" value="">
    ...
    <input type="hidden" id="id_simulacion" name="id_simulacion" value="<?php echo $_REQUEST["id_simulacion"] ?>">
    <select id="id_comercial" name="id_comercial" style="display: none;">
        <option selected value="<?php echo $fila["id_comercial"] ?>"></option>
    </select>
    <input type="hidden" id="pagaduria" name="pagaduria" value="<?php echo $fila["pagaduria"] ?>">
    ...
    <input type="hidden" id="pagaduria" name="pagaduriab" value="<?php echo $_REQUEST["pagaduriab"] ?>">
    ...
    <table border="0" cellspacing=1 cellpadding=2 align="center">
        <tr>
                ...
                <div class="box1 clearfix">
                    <table border="1" cellspacing=1 cellpadding=2 align="right">
                        ...
                        <tr>
                            ...
                            <td><input id="cedula" type="text" name="cedula" value="<?php echo $fila["cedula"] ?>" style="width:200;" readonly></td>
                        </tr>
                        <!-- 002 -->
                        <tr>
            ...
            ?>
                ...
                <td>&nbsp;</td>
                <td valign="top">
                    <h2><?php if ($fecha_prepago) { ?>INFORMACI&Oacute;N PREPAGO<?php } else { ?>CANCELACI&Oacute;N POR RETANQUEO<?php } ?></h2>
                    <div class="box1 clearfix">
                        <table border="0" cellspacing=1 cellpadding=2>
                            <?php
                            ...
                            ?>
                                <tr>
                                    <td>SOPORTE</td>
                                    <td><a href="#" onClick="window.open('<?php 
                                    echo generateBlobDownloadLinkWithSAS("simulaciones", $_REQUEST["id_simulacion"] . "/varios/" . $nombre_grabadoprep) 
                                    
                                    
                                    ?>', 'SOPPREP<?php echo $_REQUEST["id_simulacion"] ?>','toolbars=yes,scrollbars=yes,resizable=yes,width=800,height=600,top=0,left=0');"><img src="../images/archivo.png" title="Archivo Soporte"></a></td>
                                </tr>
                            <?php
                    ...
                    <td valign="top">
                        ...
                        <div class="box1 clearfix">
                            <table border="0" cellspacing=1 cellpadding=2>
                                <tr>
                                    <td>SALDO CAPITAL</td>
                                    <td><input type="text" otro="<?=$capital_recaudado;?>" name="saldo_capital" value="<?php echo number_format($saldo_capital, 0, ".", ",") ?>" size="15" style="text-align:right;" readonly></td>
                                </tr>
                                <tr>
                                    <td>INTERESES CORRIENTES</td>
                                ...
                                ?>
                                    <tr>
                                        <td>SEGURO DE VIDA</td>
                                        <td><input type="text" name="seguro_vida2" value="<?php echo number_format($seguro_total, 0, ".", ",") ?>" size="15" style="text-align:right;" readonly></td>
                                    </tr>
                                <?php
            ...
            <td valign="top">
                ...
                <div class="box1 clearfix" style="padding-bottom: 24px !important;">
                    <table border="1" class="table" >
                        <tr align="center" style="text-align: center;">                       
                            <td align="center">
    ...
    <table border="0" cellspacing=1 cellpadding=2" align="center" class="tab1">
        ...
        ?>
           <tr>
                ...
                <td>
                    <?php if ($fila1["nombre_grabado"]) { ?>
                        <a href="#" onClick="window.open('<?php echo generateBlobDownloadLinkWithSAS("simulaciones", $_REQUEST["id_simulacion"] . "/varios/" . $fila1["nombre_grabado"]) ?>', 'SOP<?php echo $fila1["consecutivo"] . "_" . $fila1["cuota"] ?>','toolbars=yes,scrollbars=yes,resizable=yes,width=800,height=600,top=0,left=0');">
                            <img src="../images/archivo.png" title="Archivo Soporte">
                        </a>
                    <?php } else {
                        echo "&nbsp;";
                    } ?>
                ...
                <?php 
                    if (($_SESSION["S_TIPO"] == "ADMINISTRADOR" || $_SESSION["S_TIPO"] == "CARTERA") && $_SESSION["S_SOLOLECTURA"] != "1") { 
                        ...
                        if (!$fila1["aplicado_desde_bolsa"]) {
                            if($cont == $filas){
                                echo '<input type="checkbox" name="chk'.$fila1["consecutivo"].'_'.$fila1["cuota"].'" value="1">';
                            }else{
                                echo '<input type="checkbox" name="chk'.$fila1["consecutivo"].'_'.$fila1["cuota"].'" value="1" disabled>';
                            }
                        } else {
                            echo '&nbsp';
                        }
        ...
        <tr>
            <td align="center">
                <?php if (($_SESSION["S_TIPO"] == "ADMINISTRADOR" || $_SESSION["S_TIPO"] == "CARTERA" || $_SESSION["S_SUBTIPO"] == "ANALISTA_JURIDICO" || $_SESSION["S_SUBTIPO"] == "ANALISTA_CARTERA") && !($fila["estado"] != "CAN" && $fecha_prepago) && $_SESSION["S_SOLOLECTURA"] != "1") {
                ?>
                <input type="button" value="Ingresar Recaudo" onClick="reajustarPlanPago('<?php echo $_REQUEST["id_simulacion"];?>')">
                <?php } ?>
            </td>
            <td align="center"><?php if (($_SESSION["S_TIPO"] == "ADMINISTRADOR" || $_SESSION["S_TIPO"] == "CARTERA" || $_SESSION["S_SUBTIPO"] == "ANALISTA_JURIDICO" || $_SESSION["S_SUBTIPO"] == "ANALISTA_CARTERA") && !($fila["estado"] != "CAN" && $fecha_prepago) && $_SESSION["S_SOLOLECTURA"] != "1") { ?><input type="button" value="Ingresar Recaudo" onClick="reajustarPlanPago('<?php echo $_REQUEST["id_simulacion"];?>')"><?php } ?></td>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <?php if (($_SESSION["S_TIPO"] == "ADMINISTRADOR" || $_SESSION["S_TIPO"] == "CARTERA") && $_SESSION["S_SOLOLECTURA"] != "1") { ?>
                <td align="center">
                    <input type="image" src="../images/delete.png" title="Borrar" onClick="document.formato.action.value = 'borrarrecaudo'">
                </td>
            <?php } ?>
        </tr>
    </table>
...
<script type="text/javascript">
		function reajustarPlanPago(id){
			$.ajax({
						url: '../servicios/cartera/consultarPlanDePago.php',
						type: 'POST',
						...
						success: function(json) {
							...
							if(json.code != ''){
								if(json.code == 404){
									...
									Swal.fire({
                                        title: 'Este credito no tiene plan de pago. ¿Desea generarlo?',
                                        ...
                                        $.ajax({
                                            url: '../servicios/cartera/generarPlanDePago.php',
                                            type: 'POST',
                                            data: { id_simulacion : id },
                                            dataType : 'json',
                                            success: function(json) {
                                                ...
                                                if(json.code != ''){
                                                    ...
                                                    Swal.fire('No se Pudo Reajustado', '', 'error')
                                                }
                                            }
                                        });
									...
									window.open('aplicarpago.php?ext=<?php echo $_REQUEST["ext"] ?>&id_simulacion=<?php echo $_REQUEST["id_simulacion"] ?>&descripcion_busqueda=<?php echo $_REQUEST["descripcion_busqueda"] ?>&sectorb=<?php echo $_REQUEST["sectorb"] ?>&pagaduriab=<?php echo $_REQUEST["pagaduriab"] ?>&estadob=<?php echo $_REQUEST["estadob"] ?>&buscar=<?php echo $_REQUEST["buscar"] ?>&page=<?php echo $_REQUEST["page"] ?>', 'APLICARPAGO', 'toolbars=yes,scrollbars=yes,resizable=yes,width=1000,height=500,top=0,left=0');
								}
							}else {
								Swal.fire('No se Pudo Reajustado', '', 'error')
							}
...
<script type="text/javascript" src="../js/consultas_centrales.js"></script>
<!-- Toastr -->
